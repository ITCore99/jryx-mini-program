...
const API_BASE_URL = 'https://hs.afayou.com' + root;
 //const API_BASE_URL = 'https://jryx.natapp4.cc' + root;
//const API_BASE_URL = 'http://192.168.1.24:8080' + root;
module.exports = {
    ...
    JryxGoodsList: API_BASE_URL +'jryx/goods/list',
    ...
    WXPayPrepayId: API_BASE_URL + 'pay/prepay', //获取微信统一下单prepay_id
    PayPrepayId: API_BASE_URL + 'pay/cardPay',//余额支付
    ...
    SmsCode: API_BASE_URL + 'guest/user/smscode', //发送短信
    ...
    CardList: API_BASE_URL + 'card/selectActivateStatusCards',//查询会员卡的列表
    CardActive: API_BASE_URL +'card/activateCard',//更改会员卡的状态
    BindPhone: API_BASE_URL +'user/isBindMobile',//查询手机号是否绑定
    Dump: API_BASE_URL +'/card/toUpCard', // 转储
    Trade: API_BASE_URL +'userfinance/list',//流水列表
    TranCard: API_BASE_URL+'card/TransCard',//手动激活会员卡
    Userfinance:API_BASE_URL+'userfinance/info',//流水详情
    JudgeVip: API_BASE_URL +'card/isMember',//判断用户是否是卡会员
    
    AirOrder: API_BASE_URL +'customorderdemand/save',//保存订制
    CardRecharge: API_BASE_URL +'order/cardRechargeOrder' ,//卡充值,
    Vipinfo:API_BASE_URL+'uservip/info',//获取会员的用户信息
    TemporyVip: API_BASE_URL +'uservip/isVip',//判断是不是临时会员
    VipPAyOrder:API_BASE_URL+'order/vipPayOrder',//成为会员下单
    GetQRCode: API_BASE_URL +'jryx/user/createShareQRcode',//获取二维码

   LooseInfo: API_BASE_URL + 'jryx/goods/detail',//游轮的信息
   GetBranch: API_BASE_URL + 'jryx/subbranch/queryAll', //查询分店信息
   GetSteward: API_BASE_URL + 'deptinfo/info',
   GetDatePrice: API_BASE_URL +'jryx/productprice/queryAll'
